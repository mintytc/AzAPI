 ...
 *
 */
public class FurnaceGUI extends GUIBuilder<FurnaceGUI> {

    public FurnaceGUI(JavaPlugin plugin) {
        super(plugin);
    }

    @Override
    public Inventory build(Player viewer) {
        Inventory inv = Bukkit.createInventory(null, InventoryType.FURNACE, getTitle() == null ? "" : getTitle());
