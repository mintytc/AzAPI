 ...
 *
 */
public class HopperGUI extends GUIBuilder<HopperGUI> {

    public HopperGUI(JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public Inventory build(Player viewer) {
        Inventory inv = Bukkit.createInventory(null, InventoryType.HOPPER, getTitle() == null ? "" : getTitle());
