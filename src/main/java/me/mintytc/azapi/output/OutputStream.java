package me.mintytc.azapi.output;

import me.mintytc.azapi.events.EvtLog;
import me.mintytc.azapi.output.format.Format;
import me.mintytc.azapi.output.format.color.FChatColor;
import me.mintytc.azapi.output.format.color.FGradient;
import me.mintytc.azapi.output.format.color.FRgb;
import me.mintytc.azapi.output.format.replacer.FReplacement;
